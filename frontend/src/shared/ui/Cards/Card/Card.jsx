/**
 * @file Универсальный компонент карточки.
 * @module shared/ui/Cards/Card
 */
...
/**
 * Компонент Card.
 * Отображает информацию в зависимости от типа (wishes, wishlists, friends).
 * Поддерживает предпросмотр изображений, выпадающее меню действий и навигацию.
 * * @component
 * @param {Object} props - Свойства компонента.
 * @param {Object} props.item - Объект данных (желание, вишлист или профиль друга).
 * @param {'wishes'|'wishlists'|'friends'} props.type - Тип карточки, определяющий рендеринг.
 * @param {Function} [props.onEdit] - Функция для вызова редактирования элемента.
