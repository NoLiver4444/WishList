/**
 * @file Основной компонент навигации с анимированным выделением.
 * @module shared/ui/Interface/Navigation
 */
 ...
 * Использует `framer-motion` для плавной анимации фона (capsule) активного пункта меню.
 * Следит за изменением размера окна для корректного позиционирования индикатора.
 * * @component
 */
const Navigation = () => {
